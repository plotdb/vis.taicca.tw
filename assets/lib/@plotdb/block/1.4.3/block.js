...
(function(){
  var rescope, sanitize, parseNameString, pubsub, block, slice$ = [].slice;
    ...
    module: {
      ...
      t: function(v){
        ...
        for (i$ = 0, to$ = vs.length; i$ < to$; ++i$) {
          i = i$;
          v = vs[i];
          ref$ = v.split(':'), ns = ref$[0], t = slice$.call(ref$, 1);
          t = t.join(':');
  ...
  block['class'].prototype = import$(Object.create(Object.prototype), {
    _init: function(){
      ...
      return block.init().then(function(){
        ...
        var i18n, lng, res, ns, results$ = [];
        i18n = this$['interface'].pkg.i18n || {};
        for (lng in i18n) {
          res = i18n[lng];
          ns = this$['interface'].pkg.name + "@" + this$['interface'].pkg.version;
          results$.push(block.i18n.module.addResourceBundle(lng, ns, res, true, true));
        }
        return results$;
      }).then(function(){
        var ref$, k, v;
