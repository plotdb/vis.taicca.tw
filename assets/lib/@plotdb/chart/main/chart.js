(function(){
  var svgns, parent, Aniloop, visibilityObserver, resizeObserver, Chart;
  ...
  Chart.prototype = import$(Object.create(Object.prototype), {
    _init: function(){
      ...
      if (this.prepareSvg) {
        if (!(this.svg = this.root.querySelector('svg'))) {
      ...
      this.aniloop = new Aniloop();
      visibilityObserver.add(this.aniloop);
      this.aniloop.on('tick', function(){
        return this$.tick();
      });
